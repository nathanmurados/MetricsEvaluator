...
{
    public class SolutionJavaScriptMetricsPresenter : ISolutionJavaScriptMetricsPresenter, IHasHumanInterface
    {
        ...
        public SolutionJavaScriptMetricsPresenter(IHumanInterface ux, IDirectoryFileEvaluator directoryFileEvaluator, IJavaScriptStatsPresenter javaScriptStatsPresenter, IFilteredFilesEvaluator filteredFilesEvaluator, IJavaScriptStatsStorer cssJavaScriptStorer)
        {
